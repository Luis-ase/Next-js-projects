          ...
          <div className="flex justify-center">
            ...
            <div className="flex justify-between items-center">
              ...
              <div className="mx-4 sm:mx-8 md:mx-16">
                ...
                <div className="flex justify-around items-center text-gray-400">
                  <p className="mx-1">
                    <a href="https://github.com/Luis-ase" target="_blank" className="hover:underline ">Github</a>
                  </p>
                  <p className="mx-1">
                    <a href="https://www.linkedin.com/in/michael-condori-2a0394251/" target="_blank" className="hover:underline">Linkdln</a>
                  </p>
                </div>
              </div>
