  ...
  return (
    <div>
      ...
      <div className='my-8 m-8 flex items-center justify-center flex-col gap-4'>
        ...
        <Link href={"/proyectos"}>
        <button className="relative px-5 py-2.5 transition-all ease-in duration-75 bg-white dark:bg-gray-900 rounded-md group-hover:bg-opacity-0" onClick={undefined}>
          get Start
        </button>
        </Link>
      </div>
